									...
									<td>
										<div class="table-data-feature">
											<button class="item" data-toggle="tooltip"
												data-placement="top" title="새 글쓰기" onclick="location='noticeForm'">
												<i class="zmdi zmdi-mail-send"></i>
											</button>
											<button class="item" data-toggle="tooltip"
												data-placement="top" title="수정하기" onclick="location='noticeUpdateForm?nnum=${e.nnum}'">
												<i class="zmdi zmdi-edit"></i>
											</button>
											<button class="item" data-toggle="tooltip"
												data-placement="top" title="지우기" onclick="location='noticeDelete?nnum=${e.nnum}'">
